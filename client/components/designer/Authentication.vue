...
const login = () => {
    message.value = [{type: 'success', value: 'success'}]
}
...
<template>
    ...
    <div v-if="isOpen" class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-full w-full backdrop-blur-sm" @click="closeAuth"></div>
    <Transition name="slide">
        <div v-if="signUpForm" class="absolute border top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 py-5 px-10 rounded-xl w-96">
            <div class="mb-10">
            ...
            <div class="w-full text-c-neutral-500">
                ...
                <div class="text-center">
                    ...
                    <p class="text-center w-full text-sm">By creating a ******** account you accept our <br> Terms of service and Privacy Policy</p>
                </div>
            </div>
        </div>
    </Transition>
    ...
    <Transition name="slide">
        <div v-if="logInForm" class="absolute border top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 py-5 px-10 rounded-xl w-96">
            <div class="mb-10">
    ...
    <Transition name="slide">
        <div v-if="resetPasswordForm" class="absolute border top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 py-5 px-10 rounded-xl w-96">
            <div class="mb-10">
